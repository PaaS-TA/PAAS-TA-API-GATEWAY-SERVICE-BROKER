...
public class TestConstants {
    ...
    public static final String DASHBOARDCLIENT_ID = "dashboardClient_id";
    public static final String DASHBOARDCLIENT_SECRET = "dashboardClient_secret";
    public static final String DASHBOARDCLIENT_REDIRECTURI = "dashboardClient_redirectUri";
